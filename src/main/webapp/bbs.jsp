	  ...
	  %>
	    <tr>
	      ...
	      <td> <%= list.get(i).getBbs_id()%></td>
	       <td> <a href = "view.jsp?bbs_id=<%= list.get(i).getBbs_id()%>" > <%=list.get(i).getBbsTitle() %> </a> </td>
	        <td> <%= list.get(i).getUser_id() %></td>
	       <td> <%= list.get(i).getBbsDate().substring(11,13) + "시"  %></td>
...
<a class="btn btn-primary pull-right" href="write.jsp" role="button">글쓰기</a>
  </div>
</div>
